...
local outputPath = "/projects/pcsri/PetaVision/output/sound/output_nf" .. dictionarySize .. "_nonvoxp/training_" .. VThresh .. "/";
...
groupType = "PvpLayer";
    ...
    inputPath                           = "../chinese_opera/trainoutnonvoxp.pvp";
    offsetAnchor                        = "cc";
    offsetX                             = 0;
    offsetY                             = 0;
