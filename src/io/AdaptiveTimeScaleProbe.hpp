...
protected:
   ...
   virtual int checkpointRead(char const * checkpointDir, double const * timestampPtr);
   virtual int checkpointWrite(bool suppressCheckpointIfConstant, char const * checkpointDir, double timestamp);
